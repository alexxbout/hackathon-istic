    ...
    <UCard class="min-w-[500px] border-2  border-gray-200 group duration-200 relative p-4  shadow-lg rounded-lg">
      ...
      <div class="flex gap-2 mt-8 w-full">
        ...
        <UButton
            ...
            class="w-1/2 text-center flex justify-center items-center border-2 border-black bg-white text-black hover:border-green-500 hover:text-green-500 hover:bg-white" color="green" size="md"
            variant="solid"
            @click="handleAccessDetails(poolId)">
          <UIcon class="w-5 h-5" name="ix:eye-filled"/>
          Accéder aux détails
        </UButton>
        ...
        <UButton
            :ui="{ rounded: 'rounded-full' }"
            class="w-1/2 text-center flex justify-center items-center border-2 border-black bg-white text-black hover:text-green-500 hover:border-green-400 hover:bg-white" color="green" size="md"
            variant="solid"
            @click="handleUsePool(poolId)">
          <UIcon class="w-5 h-5" name="ix:certificate-success-filled"/>
          Utiliser ce pool
        </UButton>
      </div>
